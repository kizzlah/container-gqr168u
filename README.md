...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gqr168u.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gqr168u.containers.anotherwebservice.com/
...
```
git clone git@github.com:kizzlah/container-gqr168u.git
cd container-gqr168u
```
...
```
docker attach container-gqr168u
```
